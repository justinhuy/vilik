      ...
      >
        ...
        >
          ...
          >
            <g opacity="0.66">
              <path
                d="M345.576 467.075C290.065 674.246 413.038 887.088 620.243 942.473C827.448 997.858 1040.42 874.811 1095.93 667.641C1151.44 460.471 1028.47 247.628 821.267 192.243C614.061 136.858 401.088 259.905 345.576 467.075Z"
                fill="url(#paint0_radial_19_649)"
              />
              <g filter="url(#filter0_f_19_649)">
                <ellipse
                  rx="312.271"
                  ry="430.067"
              ...
              <g filter="url(#filter1_f_19_649)">
                <ellipse
                  rx="312.271"
                  ry="205.551"
                  transform="matrix(-0.260847 0.96538 -0.96546 -0.26055 870.895 494.959)"
                  fill="#041128"
                />
              </g>
            </g>
            <defs>
              ...
              >
                ...
                <feGaussianBlur
                  ...
                  result="effect1_foregroundBlur_19_649"
                />
              </filter>
              <filter
                id="filter1_f_19_649"
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-3">
              ...
              <div className="h-auto bg-white-blur p-[32px] mb-[16px] border-r-blur">
                ...
                <p className="text-[#DCDCDC]">
                  With Vilik's cryptocurrency wallet, you do not need passwords
                  or third-party servers to store digital currency. We ensure
                  high cybersafety and protect users from DDoS with the PSD2
                  standard, which is identical to European security
                </p>
              </div>
              ...
              <div className="h-auto bg-white-blur p-[32px] mb-[16px] border-r-blur">
                ...
                <p className="text-[#DCDCDC]">
                  ...
                  systems offers the fair Vilik's Minigame/ Lucky game where
                  users can play and earn diamonds without being afraid of
          ...
          <div className="container mx-auto relative">
            ...
            <div
              ...
              style={{
                ...
                left: "-192px",
                top: "-98px",
                background: "rgba(105, 0, 238, 0.5)",
                filter: "blur(144.149px)",
              }}
            ></div>
            ...
            <div
              ...
              style={{
                ...
                left: "119.2px",
                top: "10px",
                background: "rgba(114, 54, 220, 0.44)",
                filter: "blur(200px)",
              }}
            ></div>
            ...
            <div
              ...
              style={{
                ...
                background: "#3D17E3",
                opacity: "0.67",
                filter: "blur(311.806px)",
                transform: "matrix(0.96, 0.37, -0.27, 0.94, 0, 0)",
              }}
            ></div>
            <div
              className="absolute"
              style={{
                ...
                right: "-90px",
                bottom: "-100px",
                background: "rgba(0, 240, 255, 0.44)",
                filter: "blur(150px)",
                transform: "matrix(0.96, 0.38, -0.28, 0.93, 0, 0)",
              }}
            ></div>
          </div>
        </section>
              ...
              <div>
                ...
                <div>
                  ...
                  <p className="text-zinc-200">
                    ...
                    advancing Aura's goals by facilitating integrations with the
