    ...
    >
      ...
      >
        ...
        <div className="screens__wrapper" ref={el}>
          ...
          >
            <div className="z-10 screen__container">
              <h5 className="sub-heading text-center text-gradient-blue text-[24px] leading-[29px] mb-[16px] lg:text-[40px] lg:leading-[48px] lg:mb-[32px] lg:leading-[48px] relative z-10">
                Trust by
              </h5>
