    ...
    >
      ...
      >
        <div ref={el}>
          ...
          >
            <div className="screen__container z-10">
              <h5 className="sub-heading text-center text-gradient-blue text-[40px] mb-[54px] leading-[48px] relative z-10">
                Roadmap
              </h5>
                ...
                >
                  <SwiperSlide>
                    <div className="flex flex-wrap justify-center items-center group relative">
                      ...
                      <p className="w-full text-zinc-50 text-[28px] leading-[34px] mb-[16px] font-bold text-center font-kanit">
                        Q1 - 2022
                      </p>
          ...
          >
            <div className="screen__container z-10">
              <h5 className="sub-heading text-center text-gradient-blue text-[40px] mb-[32px] leading-[48px] relative z-10">
                Trust by
              </h5>
          ...
          >
            <div className="screen__container z-10 w-full">
              <h5 className="sub-heading text-gradient-blue text-[29px] mb-[32px] leading-[48px] relative z-10">
                Our Team
              </h5>

              <div className="flex items-end space-x-[20px]">
                <h3 className="text-gradient-blue text-[20px] leading-[24px] relative top-[7px]">
                  Leadership
                </h3>
              ...
              <div className="grid grid-cols-12 mt-[45px]">
                <div className="col-start-3 col-end-10">
                  <div className="flex space-x-[32px]">
                    <div className="w-[117px] h-[117px] border-linear bg-gray-blur-015"></div>
                    <div className="flex-1">
                      <p className="tex-[20px] leading-[28px] text-zinc-50 font-semibold mb-[2px]">
                        TBA
                      </p>
                      <p className="mb-[33px]">TBA</p>
              ...
              <div className="grid grid-cols-2 mt-[34px] space-x-[39px]">
                <div>
                  <div className="flex space-x-[32px]">
                    <div className="w-[117px] h-[117px] border-linear bg-gray-blur-015"></div>
                    <div className="flex-1">
          ...
          >
            <div className="screen__container z-10 w-full">
              ...
              <Swiper
                slidesPerView="auto"
                spaceBetween={56}
                className="box team-slider mb-[25px]"
              >
                <SwiperSlide>
                  <div className="text-[14px] leading-[20px]">
                    <div className="w-[100px] h-[100px] border-linear bg-gray-blur-015 mb-[3px]"></div>
          ...
          <div
            className={`screen relative h-screen w-full flex flex-col items-center justify-center ${
              activeSection === 13 ? "active" : ""
            }`}
          >
