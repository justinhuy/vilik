                  ...
                  <SwiperSlide>
                    <div className="flex h-full p-[24px] lg:p-[32px] bg-white-blur">
                      ...
                      <div className="pl-[24px] flex-1">
                        ...
                        <p className="text-[12px] leading-[18px] lg:text-[14px] leading-[21px] text-[#DCDCDC]">
                          A centralized framework means less revenue flows back
                          to content the ecosystem.
                        </p>
                      </div>
                    </div>
                  </SwiperSlide>
                    ...
                    <div className="flex h-full p-[24px] lg:p-[32px] bg-white-blur">
                      ...
                      <div className="pl-[24px] flex-1">
                        ...
                        <p className="text-[12px] leading-[18px] lg:text-[14px] leading-[21px] text-[#DCDCDC]">
                          ...
                          earn streaming revenues. Therefore, artists,
                          producers, streamers, and viewers jointly enjoy the
